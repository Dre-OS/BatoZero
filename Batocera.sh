...
# Download Zerotier
if [[ "$ARCH" == x86_64* ]]; then
 curl -LJO github.com/Jhaiywroumne/BatoZero/releases/download/Latest/zerotier-one-aarch64.tar.gz
elif [[ "$ARCH" == arm* ]]; then
 curl -LJO github.com/Jhaiywroumne/BatoZero/releases/download/Latest/zerotier-one-x86_64.tar.gz
else
